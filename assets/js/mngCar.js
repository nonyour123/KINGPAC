    ...
    function shDataTable()  {
        ...
        $.ajax({
            ...
            success: function (data) {
                    ...
                    html += `
                        <tr>
                            ...
                            <td class="" style="">
                                ...
                                <a href="" class="tblEditBtn btn btn-info " data-bs-toggle="modal" data-bs-target="#mdlEdit" id="btnEdit" data-id="${data[i].sa_id}">
                                    <i class="bx bxs-edit"><div class="fas fa-search"></div></i>
                                </a>
                            </td>
                        </tr>`;
                ...
                $('#tblManageCar tbody').html(html)
                $('#tblManageCar').DataTable()
	                        .promise()
	                        .done(() => {
	                            $("#tblManageCar").DataTable({
	                                scrollX: true,
