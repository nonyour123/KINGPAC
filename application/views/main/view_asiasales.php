        ...
        <nav>
            <div class="container">
                <ol>
                    ...
                    <li>ASIA/OSINIA EXPOER SALES</li>
                </ol>
            </div>
        </nav>
    </br>
 ...
 <!-- ======= Our Team Section ======= -->
    <section id="button" class="team pt-0">
        ...
        <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    ...
                    <a class="btn btn-outline-danger" href="<?php echo base_url('Sale/sale3'); ?>" role="button">CUSTOMER RELATIONS</a>
    ...
    <!-- ======= Our Team Section ======= -->
        <section id="team" class="team pt-0">
            ...
            <span>ASIA/OSINIA EXPORT SALES</span>
            <h2>ASIA/OSINIA EXPORT SALES</h2>
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\SM\WORANUCH BOONPRASERT.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>WORANUCH BOONPRASERT</h4>
                                <span>assistant manager</span>
                                <span>assistant manager asia/osinia export sales</span>
                                <p>Employee ID 090230</p>
                                <p>E-mail woranuch@king-pac.com</p>
                                <p>Phone 671</p>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\SM\ON-USA THATSANACHAROENWONG.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>ON-USA THATSANACHAROENWONG</h4>
                                <span>assistant manager</span>
                                <span>assistant manager asia/osinia export sales</span>
                                <p>Employee ID 090254</p>
                                <p>E-mail onusa@king-pac.com</p>
                                <p> Phone 149</p>
                                <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-lg-4 col-md-6 d-flex mx-auto">
                    <div class="member">
                        <img src="{base_url}design\assets\img\employee\SM\PHITTHAYAPORN SAKULYYODMANEE.png" class="img-fluid" alt="">
                        <div class="member-content">
                            <h4>PHITTHAYAPORN SAKULYYODMANEE</h4>
                            <span>officer</span>
                            <span>officer asia/osinia export sales</span>
                            <p>Employee ID 092558</p>
                            <p>E-mail peem@king-pac.com</p>
                            <p>Phone 672</p>
                            <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                            <div class="social">
                                <a href=""><i class="bi bi-twitter"></i></a>
