<main id="main">
    ...
    <div class="breadcrumbs">
        ...
        <nav>
            <div class="container">
                <ol>
                    <li><a href="<?php echo base_url('Financial/Financial19'); ?>">CHIEF FINANCIAL OFFICER</a></li>
     ...
     <section id="button" class="team pt-0">
        ...
        <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    ...
                    <a class="btn btn-outline-danger" href="<?php echo base_url('Financial/Financial20');?>" role="button">FINANCE&ACCOUNTING</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('Financial/Financial1'); ?>" role="button">INFORMATION TECHNOLOGY</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('Financial/Financial3'); ?>" role="button">BUSINESS STRATEGY</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('Financial/Financial4'); ?>" role="button">IMPORT</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('Financial/Financial5'); ?>" role="button">EXPORT</a>

                    <a class="btn btn-outline-danger" href="<?php echo base_url('Financial/Financial6'); ?>" role="button">PURCHASING</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-lg-4 col-md-6 d-flex mx-auto">
                <div class="member">
                    <img src="{base_url}design\assets\img\employee\IT\SUMPHAN PAVICHAI.png" class="img-fluid" alt="">
                    <div class="member-content">
                        <h4>SUMPHAN PAVICHAI</h4>
                        <span>MANAGER</span>
    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\IT\KAMONWAN BOONPITURAK.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>KAMONWAN BOONPITURAK</h4>
            ...
            <div class="col-lg-4 col-md-6 d-flex mx-auto">
                <div class="member">
                    <img src="{base_url}design\assets\img\employee\IT\SUPACHAI NILCHA.png" class="img-fluid" alt="">
                    <div class="member-content">
                        <h4>SUPACHAI NILCHA</h4>
                        <span>Department head</span>
                        <span>Management information System </span>
                        <p>
                            Employee ID 092580
                        ...
                        <p>
                            E-mail supachai.nil@king-pac.com
                        </p>
                        <p>
                            Phone 284
                        </p>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\IT\CHANIDAPA PATTARAWANAN1.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>CHANIDAPA PATTARAWANAN</h4>
                                <span>officer</span>
                                <span>Management information System </span>
                                <p>
                                    Employee ID 091023
                                ...
                                <p>
                                    E-mail chanidapa.t@king-pac.com
                                </p>
                                <p>
                                    Phone 272
                                </p>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\IT\CHITCHAI SUKHANART.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>CHITCHAI SUKHANART</h4>
                                <span>officer</span>
                                <span>Management information System </span>
                                <p>
                                    Employee ID 092507
                                ...
                                <p>
                                    E-mail chitchai.suk@king-pac.com
                                </p>
                                <p>
                                    Phone 277
                                </p>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\IT\NATTAWOOT KHEW-ON.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>NATTAWOOT KHEW-ON</h4>
                                <span>officer</span>
                                <span>Management information System </span>
                                <p>
                                    Employee ID 092194
                                ...
                                <p>
                                    E-mail nattawoot.khe@king-pac.com
                                </p>
                                <p>
                                    Phone 277
                                </p>
