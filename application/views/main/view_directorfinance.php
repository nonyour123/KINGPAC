            ...
            <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-12 text-center">
                        <a class="btn btn-outline-danger" href="<?php echo base_url('Financial/Financial7'); ?>" role="button">FINANCIAL</a>

                        <a class="btn btn-outline-danger" href="<?php echo base_url('Financial/Financial'); ?>" role="button">ACCOUNTING</a>

                        <a class="btn btn-outline-danger" href="<?php echo base_url('Financial/Financial8'); ?>" role="button">COST ACCOUNTING</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-lg-4 col-md-6 d-flex mx-auto">
                <div class="member">
                    <img src="{base_url}design\assets\img\employee\FN\VISUT KLOMTUN.png" class="img-fluid" alt="">
                    <div class="member-content">
                        ...
                        <p>
                        E-mail Visut.klo@king-pac.com
                        </p>
                        <p>
                        Phone 279
                        </p>
                        <p>
                        © 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi
                        </p>
                        <div class="social">
