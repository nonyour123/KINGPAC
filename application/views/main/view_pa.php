        ...
        <nav>
            <div class="container">
                <ol>
                    ...
                    <li>PA & BIZ. DEVELOPMENT MANAGER</li>
                </ol>
            </div>
        </nav>
    </div><!-- End Breadcrumbs -->
        ...
        <div class="container" data-aos="fade-up">
            <div class="container" data-aos="fade-up">
                <div class="section-header">
                    ...
                    <h2>EXECUTIVE MANAGEMENT</h2>
                    <h2>PA & BIZ. DEVELOPMENT MANAGER</h2>
                </div>
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\EXM\CHANOKCHANAN THANAIMIT.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>CHANOKCHANAN THANAIMIT</h4>
                                <span>Development Manager</span>
                                <span>PA & BIZ. DEVELOPMENT MANAGER</span>
                                <p>Employee ID 092593</p>
                                <p>E-mail Chanokchanan.tha@king-pac.com</p>
                                <p>Phone 864</p>
