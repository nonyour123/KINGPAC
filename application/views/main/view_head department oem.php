            ...
            <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-12 text-center">
                        <a class="btn btn-outline-danger" href="<?php echo base_url('commercial/commercial1'); ?>" role="button">MANAGER DOMESTIC SALES</a>

                        <a class="btn btn-outline-danger" href="<?php echo base_url('commercial/commercial2'); ?>" role="button">DEPARTMENT HEAD</a>

                        <a class="btn btn-outline-danger" href="<?php echo base_url('commercial/commercial3'); ?>" role="button">OFFICER DOMESTIC SALES</a>

                        <a class="btn btn-outline-danger" href="<?php echo base_url('Financial/Financial8'); ?>" role="button">CUSTOMER SERVICE DOMESTIC</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-header">
                <h2>DOMESTIC SALES</h2>
                <h2>Head Department oem</h2>
            </div>
            <div class="col-lg-4 col-md-6 d-flex mx-auto">
                <div class="member">
                    <img src="{base_url}design\assets\img\employee\DS\TANAPORN PHOLJAROEN.png" class="img-fluid" alt="">
                    <div class="member-content">
                        <h4>TANAPORN PHOLJAROEN</h4>
                        <span>Head Department oem</span>
                        <span>OEM</span>
                        <p>Employee ID 092149</p>
                        <p>E-mail thanaporn.pol@king-pac.com</p>
                        <p>Phone 867</p>
