    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-lg-4 col-md-6 d-flex mx-auto">
                <div class="member">
                    <img src="{base_url}design\assets\img\employee\IM\CHANINPORN RATANASURASET.jpg" class="img-fluid" alt="">
                    <div class="member-content">
                        <h4>CHANINPORN RATANASURASET</h4>
                        <span>MANAGER</span>
                        <span>Import</span>
                        <p>
                            Employee ID 090701
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\IM\BANGEARN CHAYA.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>BANGEARN CHAYA</h4>
                                <span>officer</span>
                                <span>Import And Coporate Benefits</span>
                                <p>
                            Employee ID 092702

                        </p>
                        <p>
                            E-mail bangearn@king-pac.com
                        </p>
                        <p>
                            Phone 231
                        </p>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\IM\SIWANAN TRIAMTANA.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>SIWANAN TRIAMTANA</h4>
                                <span>officer</span>
                                <span>Import And Coporate Benefits</span>
                                <p>
                            Employee ID 092704
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\IM\VEERINTIRA SIRIBUT.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>VEERINTIRA SIRIBUT</h4>
                                <span>officer</span>
                                <span>Import And Coporate Benefits</span>
                                <p>
                            Employee ID 092519
                        ...
                        <p>
                            E-mail veerintira.sir@king-pac.com
                        </p>
                        <p>
                            Phone 231
                        </p>
