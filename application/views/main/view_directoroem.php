            ...
            <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-12 text-center">
                        ...
                        <a class="btn btn-outline-danger" href="<?php echo base_url('commercial/commercial4'); ?>" role="button">CUSTOMER SERVICE DOMESTIC</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-lg-4 col-md-6 d-flex mx-auto">
                <div class="member">
                    <img src="{base_url}design\assets\img\employee\DS\NIPHON LIMSAVARN.png" class="img-fluid" alt="">
                    <div class="member-content">
                        <h4>NIPHON LIMSAVARN</h4>
                        <span>Director</span>
                        <span>OEM</span>
                        <p>Employee ID 180002</p>
                        <p>E-mail niphon@king-pac.com</p>
                        <p>Phone 884</p>
