        ...
        <div class="container" data-aos="fade-up">
            ...
            <h2>CUSTOMER RELATIONS</h2>
                ...
                <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\SM\JARUNADE SAWANGWONG.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>JARUNADE SAWANGWONG</h4>
                                <span>officer</span>
                                <span>Customer Service</span>
                                <p>Employee ID 090317</p>
                                <p>E-mail jarunad.saw@king-pac.com</p>
                                <p>Phone 148</p>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\SM\ACHCHA CHANCHAIWECH.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>ACHCHA CHANCHAIWECH</h4>
                                <span>officer</span>
                                <span>Sales admin Officer</span>
                                <p>Employee ID 092016</p>
                                <p>E-mail achcha.cha@king-pac.com</p>
                                <p>Phone 148</p>
                                <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\SM\CHUTA SU-ANGKAWATIN.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>CHUTA SU-ANGKAWATIN</h4>
                                <span>officer</span>
                                <span>Sales admin Officer</span>
                                <p>Employee ID 090315</p>
                                <p>E-mail chuta@king-pac.com</p>
                                <p>Phone 140</p>
                                <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
