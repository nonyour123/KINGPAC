<main id="main">
    ...
    <div class="breadcrumbs">
            ...
            <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-6 text-center">
                        <h2>HUMAN RESOURCE MANAGEMENT AND DEVELOPMENT</h2>
        ...
        <div class="container">
          <ol>
            <li><a href="<?php echo base_url('hr/hr1'); ?>">HUMAN RESOURCE MANAGEMENT </a></li>
            <li>PAYROLL</li>
          </ol>
        </div>
      </nav>
    ...
    <section id="button" class="team pt-0">
        ...
        <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    ...
                    <a class="btn btn-outline-danger" href="<?php echo base_url('hr/hr2'); ?>" role="button">PAYROLL</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('hr/hr'); ?>" role="button">RECRUITMENT</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('hr/hr3'); ?>" role="button">EMPLOYEE RELATIONS</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('hr/hr4'); ?>" role="button">TRAINING</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('hr/hr5'); ?>" role="button">GENERAL AFFAIR</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container" data-aos="fade-up">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\HR\ANCHALEE KIJWONGPRASERT.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>ANCHALEE KIJWONGPRASERT</h4>
                                <span>Assistant Manager</span>
                                <span>PAYROLL</span>
                                <p>Employee ID 091115</p>
                                <p>E-mail anchalee_k@king-pac.com</p>
                                <p>Phone 301</p>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\HR\SUPAT HANMUANG.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>SUPAT HANMUANG</h4>
                                <span>Assistant Manager</span>
                                <span>PAYROLL</span>
                                <p>Employee ID 092607</p>
                                <p>E-mail supat.han@king-pac.com</p>
                                <p>Phone 303</p>
                                <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\HR\SUNSANEE PHONPUCH.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>SUNSANEE PHONPUCH</h4>
                                <span>Department head</span>
                                <span>PAYROLL</span>
                                <p>Employee ID 092009</p>
                                <p>E-mail sunsanee.pho@king-pac.com</p>
                                <p>Phone 302</p>
                                <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
        ...
        <div class="container" data-aos="fade-up">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\HR\PARICHART KOOKID.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>PARICHART KOOKID</h4>
                                <span>officer</span>
                                <span>PAYROLL</span>
                                <p>Employee ID 091182</p>
                                <p> E-mail parichart@king-pac.com</p>
                                <p>Phone 302</p>
                                <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\HR\PATTARIYA KHEOWBUMRUNG.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>PATTARIYA KHEOWBUMRUNG</h4>
                                <span>officer</span>
                                <span>PAYROLL</span>
                                <p>Employee ID 092288</p>
                                <p>E-mail pattariya.khe@king-pac.com</p>
                                <p>Phone 303</p>
                                <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
