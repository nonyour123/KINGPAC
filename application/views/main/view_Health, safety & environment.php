<main id="main">
    ...
    <div class="breadcrumbs">
        ...
        <nav>
            <div class="container">
                <ol>
                    <li><a href="<?php echo base_url('Operation/operation13'); ?>">CHIEF OPERATING OFFICER</a></li>
     ...
     <section id="button" class="team pt-0">
        ...
        <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    ...
                    <a class="btn btn-outline-danger" href="<?php echo base_url('Operation/operation11');?>" role="button">PRODUCTION MANAGEMENT</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('Operation/Operation1'); ?>" role="button">MAINTENANCE</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('Operation/Operation4'); ?>" role="button">QUAILTY MANAGEMENT</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('Operation/Operation12'); ?>" role="button">WAREHOUSE</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('Operation/Operation5'); ?>" role="button">HEALTH,SAFETY AND ENVIRONMENT</a>
    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-lg-4 col-md-6 d-flex mx-auto">
                <div class="member">
                    <img src="{base_url}design\assets\img\employee\ST\SUPAT TREEPOB.png" class="img-fluid" alt="">
                    <div class="member-content">
                        <h4>SUPAT TREEPOB</h4>
                        <span>manager</span>
                        <span>Health,Safety And Environment</span>
                        <p>Employee ID 091168</p>
                        <p>E-mail supat@king-pac.com</p>
                        <p>Phone 625</p>
    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-lg-4 col-md-6 d-flex mx-auto">
                    <div class="member">
                        <img src="{base_url}design\assets\img\employee\ST\SOMPONG WONGKAEW.png" class="img-fluid" alt="">
                        <div class="member-content">
                            <h4>SOMPONG WONGKAEW</h4>
                            <span>Safety professional</span>
                            <span>Health,Safety And Environment</span>
                            <p>Employee ID 091192</p>
                            <p>E-mail sompong@king-pac.com</p>
                            <p>Phone 774</p>
                            <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                            <div class="social">
                                <a href=""><i class="bi bi-twitter"></i></a>
            ...
            <div class="section-header">
                ...
                <div class="col-lg-4 col-md-6 d-flex mx-auto">
                    <div class="member">
                        <img src="{base_url}design\assets\img\employee\ST\ITSARET PINSUWAN.png" class="img-fluid" alt="">
                        <div class="member-content">
                            <h4>ITSARET PINSUWAN</h4>
                            <span>Safety Engineer</span>
                            <span>Health,Safety And Environment</span>
                            <p>Employee ID 091017</p>
                            <p>E-mail itsaret@king-pac.com</p>
                            <p>Phone 625</p>
                            <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                            <div class="social">
                                <a href=""><i class="bi bi-twitter"></i></a>
