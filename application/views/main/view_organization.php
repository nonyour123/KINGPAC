    ...
    <div class="breadcrumbs">
        ...
        <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    ...
                    <a class="btn btn-outline-danger" href="<?php echo base_url('organization/organization1');?>" role="button">ADVISOR</a>
                
                    <a class="btn btn-outline-danger" href="<?php echo base_url('organization/organization2'); ?>" role="button">PA & BIZ. DEVELOPMENT MANAGER</a>
    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-lg-4 col-md-6 d-flex mx-auto">
                <div class="member">
                    <img src="{base_url}design\assets\img\employee\EXM\seree julsasksrisakul.png" class="img-fluid" alt="">
                    <div class="member-content">
                        <h4>Mr. Seree Julasaksrisakul</h4>
                        <span>Chairman</span>
                        <p>Employee ID 092550</p>
                        <p>E-mail seree@king-pac.com</p>
                        <p>Phone 201</p>
    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-lg-4 col-md-6 d-flex mx-auto">
                    <div class="member">
                        <img src="{base_url}design\assets\img\employee\EXM\thawee julasaksrisakul.png" class="img-fluid" alt="">
                        <div class="member-content">
                            <h4>Thawee Julasaksrisakul</h4>
                            <span>Group Managing Director</span>
                            <p>Employee ID 092353</p>
                            <p>E-mail tavee@king-pac.com</p>
                            <p>Phone 211</p>
                            <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                            <div class="social">
                                <a href=""><i class="bi bi-twitter"></i></a>
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-lg-4 col-md-6 d-flex mx-auto">
                    ...
                    <div class="member">
                        ...
                        <img src="{base_url}design\assets\img\employee\EXM\Paiboon Julasaksrisakul.png" class="img-fluid" alt="">
                        <div class="member-content">
                            <h4>Paiboon Julasaksrisakul</h4>
                            <span>Chief Marketing Officer</span>
                            <p>E-mail piboon@king-pac.com</p>
                            <p>Phone 860</p>
                            <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                            <div class="social">
                                <a href=""><i class="bi bi-twitter"></i></a>
                ...
                <div class="col-lg-4 col-md-6 d-flex mx-auto">
                    <div class="member">
                        <div class="section-header">
                            <h2>Chief Operation Officer</h2>
                        </div>
                        <img src="{base_url}design\assets\img\employee\PDM\SOMLUK SAE-LUA.png" class="img-fluid" alt="">
                        <div class="member-content">
                            <h4>SOMLUK SAE-LUA</h4>
                            <span>Chief operation Officer</span>
                            <p>E-mail somluk@king-pac.com</p>
                            <p>Phone 601</p>
                            <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                            <div class="social">
                                <a href=""><i class="bi bi-twitter"></i></a>
                ...
                <div class="col-lg-4 col-md-6 d-flex mx-auto">
                    <div class="member">
                        ...
                        <img src="{base_url}design\assets\img\employee\EXM\Pattida Julasaksrisakul3.jpg" class="img-fluid" alt="">
                        <div class="member-content">
                            <h4>Pattida Julasaksrisakul</h4>
                            <span>Chief Financial Officer</span>
                            <p>E-mail pattida@king-pac.com</p>
                            <p>Phone 111</p>
                            <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                            <div class="social">
                                <a href=""><i class="bi bi-twitter"></i></a>
