    ...
    <section id="team" class="team pt-0">
        <div class="container" data-aos="fade-up">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\HR\RATHTASART KRIYARATH.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>RATHTASART KRIYARATH</h4>
                                <span>Department Head</span>
                                <span>Employee Relations</span>
                                <p>Employee ID 092523</p>
                                <p>E-mail Rathtasart.kri@king-pac.com </p>
                                <p>Phone 314</p>
        ...
        <div class="container" data-aos="fade-up">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\HR\KANTIDAR DOKKAEW.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>KANTIDAR DOKKAEW</h4>
                                <span>officer</span>
                                <span>Employee Relations</span>
                                <p>Employee ID 092528</p>
                                <p>E-mail kantidar.dok@king-pac.com</p>
                                <p>Phone 314</p>
                                <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\HR\CHUTIMA INTARWISAES.png" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>CHUTIMA INTARWISAES</h4>
                                <span>officer</span>
                                <span>Employee Relations</span>
                                <p>Employee ID 092529</p>
                                <p>E-mail chutima.int@king-pac.com</p>
                                <p>Phone 312</p>
                                <p> © 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex mx-auto">
                        <div class="member">
                            <img src="{base_url}design\assets\img\employee\HR\ONKAMOL PHOLYOTHA.jpg" class="img-fluid" alt="">
                            <div class="member-content">
                                <h4>ONKAMOL PHOLYOTHA</h4>
                                <span>officer</span>
                                <span>Employee Relations</span>
                                <p>Employee ID 091215</p>
                                <p>E-mail Onkamol.pho@king-pac.com</p>
                                <p>Phone 313</p>
                                <p>© 2024 KINGPAC. Industrial company limited. Designed by Sripatum Chonburi</p>
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
