...
<meta charset="utf-8">
  ...
  <title>King Pac. Industrial Co.,Ltd.</title>
  ...
  <!-- <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Angsana+New:wght@400;700&display=swap"> -->
  ...
  <link href="{base_url}design/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
  <link href="{base_url}design/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="{base_url}design/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
  <link href="{base_url}design/assets/vendor/aos/aos.css" rel="stylesheet">
...
<script>
  ...
  <script src="{base_url}design/assets/vendor/purecounter/purecounter_vanilla.js"></script>
  <script src="{base_url}design/assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="{base_url}design/assets/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="{base_url}design/assets/vendor/aos/aos.js"></script>
  <script src="{base_url}design/assets/vendor/php-email-form/validate.js"></script>

  <!-- Template Main JS File -->
  <script src="{base_url}assets/js/subnav.js"></script>
