...
class Hr extends CI_Controller {
	...
	public function hr()
	{
		$this->render_view('main/view_Recruitment');
	}

	public function hr1()
	{
		$this->render_view('main/view_directorhr');
	}

	public function hr2()
	{
		$this->render_view('main/view_payroll');
	}

	public function hr3()
	{
		$this->render_view('main/view_employeerelations');
	}

	public function hr4()
	{
		$this->render_view('main/view_training');
	}

	public function hr5()
	{
		$this->render_view('main/view_general affair');
	}
