...
class Commercial extends CI_Controller {
	...
	{
		$this->render_view('main/view_directoroem');
	}

	public function commercial1()
	{
		$this->render_view('main/view_manageroem');
	}

	public function commercial2()
	{
		$this->render_view('main/view_head department oem');
	}

	public function commercial3()
	{
		$this->render_view('main/view_officer oem');
	}

	public function commercial4()
	{
		$this->render_view('main/view_customer oem');
	}
