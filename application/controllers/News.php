...
class News extends CI_Controller {
	...
	{
		$this->render_view('main/view_mainnews');
	}

    public function news1()
	{
		$this->render_view('main/view_news1');
	}

    public function news2()
	{
		$this->render_view('main/view_news2');
	}

    public function news3()
	{
		$this->render_view('main/view_news3');
	}

    public function news4()
	{
		$this->render_view('main/view_news4');
	}

    public function news5()
	{
		$this->render_view('main/view_news5');
	}

	public function news6()
	{
		$this->render_view('main/view_news6');
	}
