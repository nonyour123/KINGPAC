...
class EditAccount extends CI_Controller {
	...
	public function editAccount()
	{
        ...
        $this->another_js = "<script src='" . base_url() . "assets/js/editProfile.js'></script>";
        $this->render_view('main/view_editAccount');
    ...
    {
        $result = $this->curPostRequest('Manage_account/show_upd_User', array('data' => serialize( array( 'id' => $this->session->userdata('userId')))));
